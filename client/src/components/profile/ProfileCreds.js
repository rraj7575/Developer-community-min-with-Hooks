    ...
    return(
      <div className='row'>
        <div className="col-md-6">
          ...
          {experience.length > 0 ?(<ul className='list-group'>{expItems}</ul>) : (<p className='text-center'> No Experience Listed</p>)}
        </div>
        <div className="col-md-6">
          <h3 className='text-center text-info'>Education</h3>
          {eduItem.length > 0 ?(<ul className='list-group'>{eduItem}</ul>) : (<p className='text-center'> No Experience Listed</p>)}
        </div>
      </div>
    )
  }
